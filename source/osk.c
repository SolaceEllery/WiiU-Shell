    ...
    while (AppRunning()) {
            ...
            for (int y = 0; y <= MAX_Y; y++) {
                if (osk_text_shift || osk_text_caps) {
                    if (config_dark_theme)
                        SDL_DrawText(RENDERER, Roboto_OSK, ((1280 - (text_width * 2)) / 2) + (100 * x), (660 - (text_height * 5)) + (60 * y), (x == osk_pos_x && y == osk_pos_y) ? TITLE_COLOUR_DARK : WHITE, osk_textdisp_shift[x + y * 10]);
                    else
                        SDL_DrawText(RENDERER, Roboto_OSK, ((1280 - (text_width * 2)) / 2) + (100 * x), (660 - (text_height * 5)) + (60 * y), (x == osk_pos_x && y == osk_pos_y) ? TITLE_COLOUR : BLACK, osk_textdisp_shift[x + y * 10]);
                } else {
                    if (config_dark_theme)
                        SDL_DrawText(RENDERER, Roboto_OSK, ((1280 - (text_width * 2)) / 2) + (100 * x), (660 - (text_height * 5)) + (60 * y), (x == osk_pos_x && y == osk_pos_y) ? TITLE_COLOUR_DARK : WHITE, osk_textdisp[x + y * 10]);
                    else
                        SDL_DrawText(RENDERER, Roboto_OSK, ((1280 - (text_width * 2)) / 2) + (100 * x), (660 - (text_height * 5)) + (60 * y), (x == osk_pos_x && y == osk_pos_y) ? TITLE_COLOUR : BLACK, osk_textdisp[x + y * 10]);
                }
            }
        }
        ...
        if (touchInfo.state == TouchEnded && touchInfo.tapType != TapNone) {
            if (tapped_inside(touchInfo, 40, 66, 108, 114)) {
                ...
                break;
            else if (((touchInfo.firstTouch.px >= ((1280 - (text_width * 2)) / 2)) && (touchInfo.firstTouch.px <= (((1280 - (text_width * 2)) / 2) + (100 * (MAX_X + 1))))) && ((touchInfo.firstTouch.py >= (660 - (text_height * 5))) && (touchInfo.firstTouch.py <= ((660 - (text_height * 5)) + (60 * (MAX_Y + 1)))))) {
                int touch_selection_y = floor(((double) touchInfo.firstTouch.py - (660 - (text_height * 5))) / 60);
                int touch_selection_x = floor(((double) touchInfo.firstTouch.px - ((1280 - (text_width * 2)) / 2)) / 100);
